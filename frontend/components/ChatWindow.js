...
export default function ChatWindow({ githubConnected, sessionId, onTitleUpdate }) {
          ...
          {githubConnected ? (
            <>
              ...
              <p className="text-brand-textMuted text-sm">
                Click <span className="font-medium text-brand-green">+ New Chat</span> in the sidebar
              </p>
            </>
          ) : (
            <>
